...
Shader "Vefects/SH_Vefects_URP_VFX_Opaque_Dither_01"
{
	Properties
	{
	...
	LOD 0
		...
		Pass
		{
			...
			float _CameraFadeFarLength;
			float _CameraFadeFarOffset;
			float _AlphaClip;
			float _Cutoff;
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				output.ase_texcoord6.z = eyeDepth;
						 ...
						 ) : SV_Target
			{
				...
				float4 ditherScreenPos31 = ScreenPosNorm;
				float2 ditherScreenPosPixel31 = ditherScreenPos31.xy * _ScaledScreenParams.xy;
				float dither31 = Dither8x8Bayer( fmod( ditherScreenPosPixel31.x, 8 ), fmod( ditherScreenPosPixel31.y, 8 ) );
				float eyeDepth = input.ase_texcoord6.z;
				float cameraDepthFade43 = (( eyeDepth -_ProjectionParams.y - _CameraFadeOffset ) / _CameraFadeLength);
				float cameraDepthFade57 = (( eyeDepth -_ProjectionParams.y - _CameraFadeFarOffset ) / _CameraFadeFarLength);
				float CAMFADE44 = ( saturate( cameraDepthFade43 ) * saturate( ( 1.0 - saturate( cameraDepthFade57 ) ) ) );
				float VCA33 = input.ase_color.a;
				dither31 = step( dither31, saturate( ( saturate( ( _DitherOpacity * CAMFADE44 ) ) * VCA33 ) * 1.00001 ) );
				float Dither38 = saturate( dither31 );
				

				float3 BaseColor = MCOL61.rgb;
				float3 Normal = NORM69;
				float3 Specular = 0.5;
				float Metallic = MET67;
				float Smoothness = SMO65;
				float Occlusion = 1;
				float3 Emission = EM63.rgb;
				float Alpha = Dither38;
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				surfaceDescription.Alpha = Dither38;
				#if defined( _ALPHATEST_ON )
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;56;-3840,896;Inherit;False;Property;_CameraFadeFarLength;Camera Fade Far Length;3;0;Create;True;0;0;0;False;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;55;-3840,1024;Inherit;False;Property;_CameraFadeFarOffset;Camera Fade Far Offset;4;0;Create;True;0;0;0;False;0;False;20;20;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;49;-3840,768;Inherit;False;Property;_CameraFadeOffset;Camera Fade Offset;2;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;48;-3840,640;Inherit;False;Property;_CameraFadeLength;Camera Fade Length;1;0;Create;True;0;0;0;False;3;Space(33);Header(Camera Fade);Space(13);False;0.1;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;32;-4352,0;Inherit;False;Property;_DitherOpacity;Dither Opacity;0;0;Create;True;0;0;0;False;3;Space(33);Header(Dither);Space(13);False;1;0.9;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;20;-1152,1280;Inherit;False;Property;_SmoothnessMin;Smoothness Min;8;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;21;-1152,1408;Inherit;False;Property;_SmoothnessMax;Smoothness Max;9;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;22;-1152,1152;Inherit;False;Property;_Metallic;Metallic;10;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;30;-880,-240;Inherit;False;Property;_Emission;Emission;13;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;26;-1408,0;Inherit;False;Property;_FlatColor;Flat Color;7;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;17;-1920,512;Inherit;False;Property;_Color;Color;6;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;23;-2816,1408;Inherit;False;Property;_NormalIntensity;Normal Intensity;12;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;12;-3200,1536;Inherit;True;Property;_Normal;Normal;11;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=36560E0D407B48E612D2DB2DD69732595B8763F8